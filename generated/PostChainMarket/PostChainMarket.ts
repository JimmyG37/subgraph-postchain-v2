...
export class PostChainMarket__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class PostChainMarket extends ethereum.SmartContract {
  static bind(address: Address): PostChainMarket {
    return new PostChainMarket("PostChainMarket", address);
  }

  getListing(
    nftAddress: Address,
    postId: BigInt
  ): PostChainMarket__getListingResultValue0Struct {
    ...
    return changetype<PostChainMarket__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    postId: BigInt
  ): ethereum.CallResult<PostChainMarket__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<PostChainMarket__getListingResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getRoyalties(nftCreator: Address): BigInt {
  ...
  try_getRoyalties(nftCreator: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getRoyalties",
